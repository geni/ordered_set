...
class OrderedSetTest < Test::Unit::TestCase
  ...
  test 'replace the set contents' do
    set = [].to_ordered_set
    set.replace([5,0,5])
  ...
  test 'have the correct size and length' do
  ...
  test 'check for any elements' do
    set = [].to_ordered_set
    assert !set.any?
  ...
  test 'support index operator' do
  ...
  test 'get a slice from a set' do
    set = [1,2,2,3,4,1,0].to_ordered_set
  ...
  test 'lookup index of element' do
    set = [1,2,2,3,4,1,0].to_ordered_set
  ...
  test 'delete elements at specified position'  do
    set = [1,2,2,3,4,1,nil].to_ordered_set
  ...
  test 'select elements from set' do
    set = [0,1,2,2,3,4,1,0].to_ordered_set
  ...
  test 'reject elements from set' do
    set = [0,1,2,2,3,4,1,0].to_ordered_set
